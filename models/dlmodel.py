...
class NNModels:
    ...
    def dl_0(self):
        ...
        x = layers.Dense(
            64, activation=tf.keras.activations.sigmoid, name="dense_2")(x)
        ...
        x = layers.Dropout(0.05)(x)
        # z = layers.Dense(
        #     12, activation=tf.keras.activations.sigmoid, name="dense_5")(x)
        # y = layers.Dense(
        #     6, activation=tf.keras.activations.sigmoid, name="dense_6")(x)
    ...
    def dl_0_compile(self, model):
        ...
        """
        model.compile(
            optimizer=keras.optimizers.Adagrad(),  # Optimizer
